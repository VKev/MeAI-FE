  ...
  return (
    <div className='space-y-6'>
      <section className='overflow-hidden rounded-[28px] border border-white/12 bg-[linear-gradient(160deg,rgba(10,13,26,0.92)_0%,rgba(8,10,18,0.95)_100%)] px-5 py-6 shadow-[0_20px_60px_rgba(3,5,12,0.45)] sm:px-7 sm:py-8 relative flex items-center justify-between'>
        ...
        <div className='flex items-center gap-4 relative z-10'>
          ...
          <div className='space-y-1'>
            <h1 className='text-3xl font-semibold tracking-tight text-white sm:text-4xl'>Workspace Analytics</h1>
            <p className='text-sm leading-relaxed text-slate-400'>Performance insights for this workspace product</p>
          </div>
        </div>
      ...
      <Breadcrumb className='px-2'>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink href={`/workspace/${workspaceId}`}>Home</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
