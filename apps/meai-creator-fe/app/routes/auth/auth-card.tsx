...
export function AuthCard({ mode }: { mode: AuthMode }) {
  ...
  return (
    <div className='relative h-190 w-full max-w-270 overflow-hidden rounded-[30px] border border-white/12 bg-[#0a0d17]/74 shadow-[0_30px_90px_rgba(0,0,0,0.5)] backdrop-blur-2xl'>
