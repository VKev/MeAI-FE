  ...
  return (
    <div className='flex flex-col gap-4 p-1 relative max-w-[1400px] mx-auto pb-6'>
      ...
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogContent className='max-w-[1000px] w-[95vw] rounded-[28px] border-white/5 bg-[#080a12] p-0 overflow-hidden shadow-2xl backdrop-blur-xl'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 p-6 max-h-[70vh] overflow-y-auto custom-scrollbar'>
