            ...
            {isLoading ? (
              ...
              <div className='flex-1 flex flex-col justify-start w-full relative'>
                {workflowState === 'idle' ? (
                  ...
                  <div className='flex-1 flex flex-col justify-start max-w-[700px] mx-auto w-full gap-6 select-none animate-in fade-in duration-300'>
                    {/* User prompt chat bubble */}
                    <div className='self-end max-w-[85%] bg-white/[0.04] border border-white/10 rounded-[24px] p-4.5 shadow-md flex flex-col gap-2.5'>
                      <span className='text-[9px] font-bold text-slate-500 uppercase tracking-widest text-right pl-1'>
                        Your Instruction
                      </span>
                      <p className='text-slate-200 text-[14px] leading-relaxed font-semibold text-right'>
                        {instruction}
                      </p>
                    </div>

                    {/* AI co-pilot response bubble */}
                    <div className='self-start max-w-[95%] bg-gradient-to-b from-[#0c0e1a] to-[#080a12] border border-white/5 rounded-[28px] p-6 shadow-2xl flex flex-col gap-5 relative overflow-hidden'>
                      <div className='absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-violet-500/10 to-transparent'></div>
                      <div className='flex items-center gap-3'>
                        ...
                        <div className='flex flex-col'>
                          <span className='text-xs font-black text-white leading-none mb-0.5'>MeAI Co-pilot</span>
                      ...
                      <p className='text-xs text-slate-400 leading-relaxed font-medium'>
                        I've analyzed your instruction and prepared the publishing workflow. Please review the details
                        below before I establish this routine:
                      </p>

                      {/* Review Grid */}
                      <div className='p-4.5 bg-black/40 border border-white/5 rounded-[20px] grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-medium'>
                        <div className='space-y-1'>
                          <span className='text-[9px] font-bold uppercase tracking-widest text-slate-500 block'>
                            Task Name
                          </span>
                          <span className='text-slate-200 font-bold block truncate max-w-full'>
                        ...
                        <div className='space-y-2.5 pt-2 border-t border-white/5 sm:col-span-2'>
                          <span className='text-[9px] font-bold uppercase tracking-widest text-slate-500 block'>
                            Target Outlets
                          </span>
                        ...
                        <div className='space-y-1 pt-2 border-t border-white/5 sm:col-span-2'>
                          <span className='text-[9px] font-bold uppercase tracking-widest text-slate-500 block'>
                            Output Constraints
                          </span>
                          <span className='text-slate-200 font-bold block'>
                            Maximum {maxLength} characters, auto-enforced caps
                          </span>
                        </div>
                      </div>

                      {/* Action buttons inside the review card */}
                      <div className='flex items-center justify-between border-t border-white/5 pt-4.5 gap-4'>
                        <Button
                          variant='ghost'
                          onClick={() => setWorkflowState('idle')}
                          className='h-10 px-5 rounded-[12px] text-slate-400 hover:text-white hover:bg-white/5 font-extrabold text-[10px] uppercase tracking-widest flex items-center gap-1.5 transition-colors select-none'
                        >
                          <Pencil className='h-3.5 w-3.5' /> Adjust Settings
                        </Button>
                        <Button
                          onClick={handleCreateAutomation}
                          className='h-10 px-8 rounded-[12px] bg-white text-black hover:bg-white/90 font-extrabold text-[10px] uppercase tracking-widest shadow-lg shadow-white/5 select-none transition-all flex items-center gap-1.5 group'
                        >
                          Deploy AI Schedule <Zap className='h-3.5 w-3.5 transition-transform group-hover:scale-110' />
                        </Button>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='pt-3 border-t border-white/5 space-y-2'>
                      ...
                      <div className='grid grid-cols-2 gap-6 pl-1 text-xs font-semibold'>
                        <div>
                          ...
                          <span className='text-slate-300 font-bold max-w-full truncate block'>
                  ...
                  {normalizeStatus(selectedSchedule.status) === 'failed' && (
                    <div className='p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 space-y-2.5 animate-in fade-in duration-300'>
                      <div className='flex items-center gap-2'>
                        ...
                        <h4 className='text-xs font-bold uppercase tracking-wider'>Global Failure</h4>
                      </div>
                            ...
                            <div key={item.id || idx} className='relative group'>
                              ...
                              <div className='space-y-1.5'>
                                <div className='flex items-center justify-between gap-2 flex-wrap'>
                                  <h5 className='text-xs font-bold text-slate-200 group-hover:text-violet-400 transition-colors leading-tight'>
                                ...
                                {item.errorMessage && (
                                  <p className='text-[10px] text-red-400/90 leading-relaxed font-semibold bg-red-950/20 border border-red-500/10 p-2 rounded-lg'>
                                    {item.errorMessage}
                                  </p>
                                )}
