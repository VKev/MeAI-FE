            ...
            <Popover open={shouldShowAiRecommendationTutorial} onOpenChange={handleAiRecommendationTutorialOpenChange}>
              ...
              >
                <div className='space-y-4'>
                  <div className='flex items-start gap-3 rounded-[16px] bg-white/[0.04] p-3'>
                    <div className='flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] bg-violet-500/15 text-white'>
                  ...
                  <label className='flex cursor-pointer items-center gap-2 rounded-[16px] bg-white/[0.05] px-3 py-2.5 text-sm text-slate-300 transition-colors hover:bg-white/[0.08]'>
                    <input
                      type='checkbox'
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='space-y-0.5'>
              ...
              <p className='text-[11px] font-medium uppercase tracking-widest text-slate-500'>
                Manage products from draft to published
              </p>
            </div>
          </div>
