          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='space-y-0.5'>
              ...
              <p className='text-[11px] font-medium uppercase tracking-widest text-slate-500'>
                Manage uploads, AI generations, and storage usage
              </p>
            </div>
          </div>
          ...
          <section className='grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4'>
            {[
              ...
              return (
                <div
                  key={item.label}
                  className='relative overflow-hidden rounded-[24px] bg-white/[0.035] p-5 transition-colors duration-200 hover:bg-white/[0.055]'
                >
                  <div className='flex items-start justify-between'>
                    ...
                    <div
                      className={`flex h-14 w-14 items-center justify-center rounded-[18px] ${accentClass}`}
                    >
