  ...
  return (
    <>
      ...
      <div className='mb-6'>
        ...
        <p className='mt-1 text-[13px] text-slate-400'>Configure provider credentials and AI generation options.</p>
      </div>
      ...
      {section === 'api-keys' ? (
        <>
          <div className='flex flex-col gap-5'>
            ...
            {loadError && (
              <div className='rounded-lg bg-red-500/10 px-4 py-3 text-[13px] text-red-300'>{loadError}</div>
            )}
