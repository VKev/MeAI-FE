...
import { SpeechToTextEngine } from '@meai-editor/core';
import type { TranscriptionProgress, TranscriptionSegment } from '@meai-editor/core';
    ...
    <div className='space-y-4 w-full min-w-0 max-w-full'>
      ...
      <div className='space-y-3 p-3 bg-background-tertiary rounded-lg'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <Select value={selectedStyle} onValueChange={setSelectedStyle} disabled={isTranscribing}>
            <SelectTrigger className='w-auto min-w-[100px] bg-background-secondary border-border text-text-primary text-[10px]'>
              <SelectValue />
            </SelectTrigger>
            <SelectContent className='bg-background-secondary border-border'>
