              ...
              .map((marker) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: editingId === marker.id ? editColor : marker.color
                    }}
                  />
                  ...
                  {editingId === marker.id ? (
                    ...
                    <>
                      ...
                      >
                        <span className='text-xs text-text-primary'>{marker.label}</span>
                        <span className='text-[10px] font-mono text-text-muted'>{formatTime(marker.time)}</span>
                      </button>
