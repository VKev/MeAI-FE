...
import type { ShapeStyle, FillStyle, StrokeStyle } from '@/core';
...
const ColorField: React.FC<{
  ...
  <div className='flex items-center justify-between gap-2'>
    ...
    <ColorPicker value={value} onChange={onChange} showAlpha={showAlpha} className='max-w-[170px]' />
  </div>
);
...
const ShapeTypeDisplay: React.FC<{
  ...
  return (
    <div className='flex items-center gap-2 p-2 bg-background-tertiary rounded-lg'>
      <div className='p-1.5 bg-background-secondary rounded'>{shapeIcons[shapeType] || <Square size={16} />}</div>
      <div>
        <span className='text-[10px] font-medium text-text-primary capitalize'>{shapeType}</span>
...
export const ShapeSection: React.FC<ShapeSectionProps> = ({ clipId }) => {
  ...
  const shapeClip = useMemo(() => getShapeClip(clipId), [clipId, getShapeClip, project.modifiedAt]);
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='space-y-2 p-3 bg-background-tertiary rounded-lg'>
        <span className='text-[10px] text-text-secondary font-medium'>Fill</span>
        <ColorField
          label='Color'
      ...
      <div className='space-y-2 p-3 bg-background-tertiary rounded-lg'>
        <span className='text-[10px] text-text-secondary font-medium'>Stroke</span>
        <ColorField
          label='Color'
      ...
      {shapeType === 'rectangle' && (
        <div className='space-y-2 p-3 bg-background-tertiary rounded-lg'>
          <span className='text-[10px] text-text-secondary font-medium'>Corners</span>
          <Slider
            label='Radius'
      ...
      <div className='space-y-2 p-3 bg-background-tertiary rounded-lg'>
        <span className='text-[10px] text-text-secondary font-medium'>Shadow</span>
        <ColorField
          label='Color'
