...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Button, ScrollArea } from '@meai-editor/ui';
  ...
  const drawGraph = useCallback(() => {
    ...
    if (activeGroup.keyframes.length > 1) {
      ...
      for (let i = 0; i <= samples; i++) {
        ...
        const value = (startKf.value as number) + ((endKf.value as number) - (startKf.value as number)) * easedT;
