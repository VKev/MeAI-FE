      ...
      <ContextMenuTrigger asChild>
        ...
        >
          ...
          <div className='w-full h-full flex items-center gap-1 px-3'>
            ...
            <span className='text-[10px] font-medium text-amber-200 truncate'>{textClip.text || 'Text'}</span>
          </div>
          {isSelected && <div className='absolute inset-0 border-2 border-amber-400 rounded-lg pointer-events-none' />}
        </div>
      </ContextMenuTrigger>
