...
export const EasingCurve: React.FC<EasingCurveProps> = ({ startX, endX, easing, color, height }) => {
  ...
  return (
    ...
    >
      <line x1='0' y1={height / 2} x2={width} y2={height / 2} stroke={color} strokeWidth='1' opacity='0.2' />
