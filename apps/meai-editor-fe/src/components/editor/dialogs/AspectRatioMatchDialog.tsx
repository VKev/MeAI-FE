        ...
        <div className='space-y-4 py-4'>
          <div className='space-y-3'>
            <div className='flex items-center justify-between p-3 rounded-lg bg-background-tertiary'>
              <div>
                <div className='text-xs text-text-tertiary mb-1'>Video Dimensions</div>
                <div className='text-sm font-medium text-text-primary'>
                  {videoWidth} × {videoHeight}
                </div>
                <div className='text-xs text-text-tertiary mt-0.5'>Aspect Ratio: {videoAspect}</div>
              </div>
            </div>

            <div className='flex items-center justify-between p-3 rounded-lg bg-background-tertiary/50 border border-border/50'>
              <div>
                <div className='text-xs text-text-tertiary mb-1'>Current Project</div>
                <div className='text-sm font-medium text-text-primary'>
                  {currentWidth} × {currentHeight}
                </div>
                <div className='text-xs text-text-tertiary mt-0.5'>Aspect Ratio: {currentAspect}</div>
              </div>
            </div>
          </div>

          <p className='text-xs text-text-tertiary'>
            Updating the project dimensions will provide the best editing experience and prevent cropping during export.
          </p>
        </div>
