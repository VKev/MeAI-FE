import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Button } from '@meai-editor/ui';
      ...
      <div className='grid grid-cols-2 gap-3'>
        <div className='space-y-1.5'>
          ...
          <Select
            ...
            onValueChange={(v) => onChange({ ...value, aspect_ratio: v as SeedreamInput['aspect_ratio'] })}
          >
        ...
        <div className='space-y-1.5'>
          ...
          <Select
            value={value.quality}
            onValueChange={(v) => onChange({ ...value, quality: v as SeedreamInput['quality'] })}
          >
            <SelectTrigger className='h-8 text-sm'>
              <SelectValue />
            </SelectTrigger>
