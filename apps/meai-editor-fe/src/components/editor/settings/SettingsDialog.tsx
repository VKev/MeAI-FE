...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@meai-editor/ui';
    ...
    <Dialog open={settingsOpen} onOpenChange={(open) => !open && closeSettings()}>
      <DialogContent className='sm:max-w-2xl max-h-[85vh] bg-background flex flex-col overflow-y-auto'>
        <DialogHeader>
          ...
          <DialogDescription>Configure preferences and manage API keys for external services.</DialogDescription>
        </DialogHeader>
