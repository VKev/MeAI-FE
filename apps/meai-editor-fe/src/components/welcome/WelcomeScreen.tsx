...
import { Clock, Layers, ArrowRight, Smartphone, Monitor, Square, FolderOpen } from 'lucide-react';
import { Button, Switch, Label } from '@meai-editor/ui';
      ...
      <div className='relative h-full flex flex-col items-center justify-center px-6'>
        <div className='w-full max-w-3xl'>
          <div className='flex flex-col items-center text-center mb-12'>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <span className='text-xl font-semibold text-text-primary tracking-tight'>Open Reel Video</span>
            </div>
        ...
        <div className='absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4'>
          <div className='flex items-center gap-2'>
            <Switch id='skip-welcome' checked={skipWelcomeScreen} onCheckedChange={setSkipWelcomeScreen} />
