    ...
    <div className='fixed inset-0 z-[9999] bg-background flex items-center justify-center p-6'>
      <div className='max-w-md text-center space-y-8'>
        ...
        <div className='space-y-3'>
          <h1 className='text-5xl font-bold text-text-primary tracking-tight'>MeAI Editor</h1>
          <div className='flex items-center justify-center gap-2'>
            <div className='h-px w-8 bg-primary/50' />
            <p className='text-lg text-text-secondary font-medium'>Desktop Only</p>
            <div className='h-px w-8 bg-primary/50' />
          </div>
        </div>
        ...
        <div className='space-y-4 bg-background-secondary/50 backdrop-blur-sm rounded-xl p-6 border border-border'>
          <p className='text-base text-text-primary leading-relaxed'>
            MeAI Editor is a professional video editor that requires a desktop or laptop computer.
          </p>
