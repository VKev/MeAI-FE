...
const STORAGE_KEY = "meai_editor_shortcuts";
const PRESET_KEY = "meai_editor_shortcut_preset";
...
const PRESETS: ShortcutPreset[] = [
  {
    id: "MeaiEditor",
    name: "MeaiEditor Default",
    description: "Default MeaiEditor shortcuts",
    shortcuts: {},
  },
  {
    id: "capcut",
...
class KeyboardShortcutsManager {
  ...
  private activePreset: string = "MeaiEditor";
