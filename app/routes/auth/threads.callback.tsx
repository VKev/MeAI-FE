...
import { handleThreadsCallback } from '@/services/client/threads.client';
...
export default function ThreadsCallback() {
  ...
  useEffect(() => {
    const processCallback = async () => {
      ...
      try {
        const response = await handleThreadsCallback({
          code,
      ...
      <div className='bg-neutral-900 rounded-2xl p-8 max-w-sm w-full mx-4 text-center border border-neutral-800'>
        {status === 'loading' && (
          <>
            ...
            <h2 className='text-lg font-semibold text-white mb-2'>Connecting Threads...</h2>
