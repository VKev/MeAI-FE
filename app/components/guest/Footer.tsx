...
export function Footer() {
  return (
    <footer className="bg-[#060609] text-gray-400 py-16 px-4 sm:px-6 lg:px-8 border-t border-purple-500/10">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 max-w-md">
            AI-powered marketing automation platform. Create, distribute, and automate your content across all channels.
          </p>
        </div>
