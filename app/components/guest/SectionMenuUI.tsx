  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <nav className='flex flex-col gap-3 p-4 bg-gray-800/95 backdrop-blur-md rounded-2xl shadow-lg border border-white/10'>
            {sections.map((section) => (
              ...
              >
                ...
                <div
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    activeSection === section.id
                      ? 'bg-linear-to-r from-blue-600 to-purple-600 scale-125'
                ...
                {/* Label tooltip */}
                <span
                  className={`absolute right-full mr-4 px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition-all duration-300 ${
                    activeSection === section.id
                      ? 'opacity-100 translate-x-0 bg-linear-to-r from-blue-600 to-purple-600 text-white'
