...
export function Hero() {
  return (
    <section className="relative min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-dark-section bg-grid-pattern overflow-hidden">
      {/* Glowing Orbs - positioned below header */}
      <div className="glow-orb-purple top-40 -left-40 animate-pulse-glow" />
      <div className="glow-orb-magenta top-60 right-0 animate-pulse-glow" style={{ animationDelay: '2s' }} />
      <div className="glow-orb-cyan bottom-20 left-1/4 animate-pulse-glow" style={{ animationDelay: '4s' }} />
