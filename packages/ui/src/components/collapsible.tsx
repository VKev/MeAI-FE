  ...
  ({ open: controlledOpen, onOpenChange, defaultOpen = false, children, ...props }, ref) => {
    ...
    return (
      <CollapsibleContext.Provider value={{ open: isOpen }}>
        <CollapsiblePrimitive.Root ref={ref} open={isOpen} onOpenChange={handleOpenChange} {...props}>
          {children}
...
const CollapsibleContent = React.forwardRef<React.ElementRef<typeof motion.div>, CollapsibleContentProps>(
